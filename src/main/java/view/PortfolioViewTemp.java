...
public class PortfolioViewTemp extends BaseView {
    ...
    public PortfolioViewTemp(PortfolioViewModel portfolioViewModel, PortfolioController portfolioController, HistoryController historyController, AnalysisController analysisController, RecommendController recommendController) {
        super("portfolio");
